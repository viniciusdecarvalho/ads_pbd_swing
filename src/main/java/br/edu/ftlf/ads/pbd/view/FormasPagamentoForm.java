...
public class FormasPagamentoForm extends Form<FormasPagamento> {
	...
	@Bind(property = "tipo", expression = "enumSet", name = "tipos")
	private EnumSetUtils<FormasPagamentoTipo> enumSetContainer;

	public FormasPagamentoForm() {
		...
		enumSetContainer = EnumSetUtils.createEnumSetContainer(FormasPagamentoTipo.class);
	...
	public EnumSetUtils<FormasPagamentoTipo> getEnumSetContainer() {
