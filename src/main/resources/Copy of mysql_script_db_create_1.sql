...
create table TbAuditorias(
    ...
    key auditorias_ik_instante (instante),
...
alter table TbAudUsuarios engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audusuarios_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audusuarios_ik_auditoria (auditoriaId),
...
alter table TbAudClientes engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audclientes_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audclientes_ik_auditoria (auditoriaId),
...
alter table TbAudFornecedores engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audfornecedores_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audfornecedores_ik_auditoria (auditoriaId),
...
alter table TbAudBancos engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audbancos_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audbancos_ik_auditoria (auditoriaId),
...
alter table TbAudFormasPagamentos engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audformaspagamentos_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audformaspagamentos_ik_auditoria (auditoriaId),
...
alter table TbAudCentroCustos engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audcentrocustos_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audcentrocustos_ik_auditoria (auditoriaId),
...
alter table TbAudCaixas engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audcaixas_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audcaixas_ik_auditoria (auditoriaId),
...
alter table TbAudMovimentos engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audmovimentos_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audmovimentos_ik_auditoria (auditoriaId),
...
alter table TbAudPagamentos engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audpagamentos_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audpagamentos_ik_auditoria (auditoriaId),
...
alter table TbAudReceitas engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint audreceitas_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key audreceitas_ik_auditoria (auditoriaId),
...
alter table TbAudDespesas engine=InnoDB,
    add column auditoriaId int unsigned not null,
    add constraint primary key(auditoriaId),
    add constraint auddespesas_fk_auditoria foreign key(auditoriaId) 
        references TbAuditorias(id),
    add key auddespesas_ik_auditoria (auditoriaId),
